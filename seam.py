...
# Cell-allowed z range. The 0.01 mm offset on CELLS_Z_MIN keeps the bottom
# face of base scale polyhedra slightly inside the wall material so it
# doesn't coincide with the base floor's top face (Manifold doesn't like
# coincident faces).
CELLS_Z_MIN    = BASE_BOT_Z + 0.01
CELLS_Z_MAX    = LID_TOP_Z
...
# === Cell polygons (the protruding scales) ===================================
